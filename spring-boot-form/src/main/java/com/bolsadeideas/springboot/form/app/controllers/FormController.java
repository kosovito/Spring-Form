...
public class FormController {
	...
	public void initBinder(WebDataBinder binder) {
		...
		// marcamos fecha como formato estricto, para que no sea tolerante con otro tipo
		// de formato
		dateFormat.setLenient(false);
		binder.registerCustomEditor(Date.class, "fechaNacimiento", new CustomDateEditor(dateFormat, false));
		// en el binder si no usamos segundo atributo, lo aplica a todos los tipos
		// String del formulario, pero si le indicamos un nombre de campo lo aplica solo
		// a este
